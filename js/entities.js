...
export function createPlayer() {
  return {
    ...
    invuln: 0,
    weapon: "gun",
    ammo: { gun: Infinity, ion: 40, plasma: 24 },
    fireCd: 0,
    trail: [],
    alive: true,
  };
...
export const WEAPONS = {
  gun: { rate: 0.1, speed: 780, damage: 12, pierce: false, color: "#9ef7ff", cost: 0, spread: 0.5 },
  ion: { rate: 0.16, speed: 980, damage: 28, pierce: true, color: "#6cff9a", cost: 1, volume: 0.55 },
  plasma: { rate: 0.08, speed: 640, damage: 40, pierce: false, color: "#ff8f5a", cost: 1, volume: 0.7 },
};
